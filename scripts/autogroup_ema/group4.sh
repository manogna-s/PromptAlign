...
RESET_STEPS=2000
CUDA_VISIBLE_DEVICES=1 nohup python train.py --root ./data --seed ${SEED} --trainer ${TRAINER} --dataset-config-file configs/datasets/domainnet_clipart.yaml --config-file configs/trainers/PromptAlign/DG_PAlign_vit_b16_c2_ep5_batch4_2ctx_cross_datasets.yaml --output-dir output/evaluation/${TRAINER}/logs --model-dir weights/maple/ori/seed1 --load-epoch 2 \
