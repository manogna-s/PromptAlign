...
class PromptAlignBatch(TrainerX):
    ...
    def build_data_loader(self):
        ...
        self.tpt_loader = self.get_batch_dataloader(self.cfg.TPT)

    def get_batch_dataloader(self, args):
    ...
    def test_time_adapt_eval(self, val_loader, model, optimizer, optim_state, scaler, args):
        ...
        for i, batch in enumerate(val_loader):
            ...
            print(images.shape, outputs_all.shape)
        ...
        for j in range(args.TTA_STEPS):
            with torch.cuda.amp.autocast():
                ...
                for k in range(selected_idx.shape[0]):
                    loss += self.avg_entropy(output[selected_idx[k]])
    ...
    def select_confident_samples_batch(self, logits, topTPT, topAlign, batch_size=4):
        ...
        return logits, sel_idx.T #logits[idxTPT], idxAlign
    ...
    def avg_entropy(self, outputs):
        ...
        # print(avg_logits.shape)
        # print(-(avg_logits * torch.exp(avg_logits)).shape)
